...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'chennai invisible grill',
    'invisible grill chennai',
    'best invisible grill chennai',
    'chennai invisible grill installation',
    'chennai invisible grill price',
    'chennai invisible grill dealer',
    'chennai invisible grill supplier',
    'chennai invisible grill manufacturer',
    'chennai invisible grill company',
    'chennai invisible grill experts',
    'chennai invisible grill professionals',
    'chennai invisible grill service',
    'chennai invisible grill solutions',
    'chennai balcony invisible grill',
    'chennai window invisible grill',
    'chennai door invisible grill',
    'invisible grills for balcony chennai',
    'invisible grills for windows chennai',
    'invisible grills for doors chennai',
    'frameless invisible grills chennai',
    'premium invisible grills chennai',
    'stainless steel invisible grills chennai',
    'child safety invisible grills chennai',
    'pet safety invisible grills chennai',
    'balcony safety grills chennai',
    'window safety grills chennai',
    'door safety grills chennai',
  ...
  openGraph: {
    ...
    title: 'Invisible Grills Chennai | Premium Window & Door Grills | #1 Grill Solution',
    description:
      'Falcon Invisible Grills offers premium invisible window grills, door grills & frameless grills in Chennai, Delhi, Mumbai, Bangalore, Hyderabad. Safe, elegant & durable solutions. Professional installation available in Chennai and all major cities.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Falcon Premium Invisible Grills Chennai - Safe & Elegant Window Protection',
        type: 'image/jpeg',
      },
    ],
  },
  twitter: {
    ...
    title: 'Invisible Grills Chennai | Premium Grill Solutions | Falcon Grills',
    description:
      'Premium invisible window & door grills with professional installation in Chennai. Safe, elegant, and durable. Available in Chennai and all major Indian cities.',
